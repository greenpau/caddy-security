...
require (
    github.com/greenpau/go-authcrunch v1.1.36
)

replace github.com/greenpau/go-authcrunch v1.1.36 => /Users/greenpau/dev/src/github.com/greenpau/go-authcrunch
```

Alternatively:

```bash
go mod edit -replace github.com/greenpau/go-authcrunch@v1.1.36=/Users/greenpau/dev/src/github.com/greenpau/go-authcrunch
```
...
```bash
        @mkdir -p ../xcaddy-$(PLUGIN_NAME) && cd ../xcaddy-$(PLUGIN_NAME) && \
                ...
                --with github.com/greenpau/go-authcrunch@v1.1.36=/home/greenpau/dev/src/github.com/greenpau/go-authcrunch
```
