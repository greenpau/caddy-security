...
require (
    github.com/greenpau/go-authcrunch v1.1.33
)

replace github.com/greenpau/go-authcrunch v1.1.33 => /Users/greenpau/dev/src/github.com/greenpau/go-authcrunch
```

Alternatively:

```bash
go mod edit -replace github.com/greenpau/go-authcrunch@v1.1.33=/Users/greenpau/dev/src/github.com/greenpau/go-authcrunch
```
...
```bash
        @mkdir -p ../xcaddy-$(PLUGIN_NAME) && cd ../xcaddy-$(PLUGIN_NAME) && \
                ...
                --with github.com/greenpau/go-authcrunch@v1.1.33=/home/greenpau/dev/src/github.com/greenpau/go-authcrunch
```
