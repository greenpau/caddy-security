...
require (
    github.com/greenpau/go-authcrunch v1.3.3
)

replace github.com/greenpau/go-authcrunch v1.3.3 => /Users/greenpau/dev/src/github.com/greenpau/go-authcrunch
```

Alternatively:

```bash
go mod edit -replace github.com/greenpau/go-authcrunch@v1.3.3=/Users/greenpau/dev/src/github.com/greenpau/go-authcrunch
```
...
```bash
        @mkdir -p ../xcaddy-$(PLUGIN_NAME) && cd ../xcaddy-$(PLUGIN_NAME) && \
                ...
                --with github.com/greenpau/go-authcrunch@v1.3.3=/home/greenpau/dev/src/github.com/greenpau/go-authcrunch
```
...
For more complex E2E testing, use `home.Caddyfile`. You can then browse to `https://auth.myfiosgateway.com:8443/`
